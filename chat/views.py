...
class ChatSessionView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            ...
            'message': 'Session chat baru sudah di buat'
        })

    def patch(self, request, *args, **kwargs):
        # tambahkan user ke chat session
        User = get_user_model()
        ...
        if owner != user:  # untuk user selain owner
        ...
        members.insert(0, owner)  # buat owner sebagai member pertama

        return Response ({
            'status': 'SUCCESS', 'members': members,
            'message': '%s bergagbung di chat' % user.username,
